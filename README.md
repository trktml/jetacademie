...
- `/kampanyalar`: Öğrenci Gelişim Kampanyaları bölümü. Kitap okuma maratonları (30 Günde 1 Eser), 100.000 Salavat halkası, 40 gün sabah namazı istikameti ve aileye hürmet seferberlikleri gibi dönemsel hedefleri kapsar. Durum sekmeleri (Aktif, Yaklaşan, Tamamlanan), ilerleme çubukları, interaktif katılım takibi ve detaylı haftalık uygulama adımları içerir.
